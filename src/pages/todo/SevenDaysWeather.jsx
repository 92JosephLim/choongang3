...
const SevenDaysWeather = () => {
    ...
    return (
       ...
       <div id="contentSection" className="text-3xl text-black flex grid-cols-2 bg-[#FFFFFF] mb-10" style={{ display: "flex", flexDirection: "column", flexWrap: "row" }}>
            <div id="Mapweather" style={{ alignSelf: "center", paddingRight: "50px" }}>
    ...
    <span
        id="campingLocal"
        className={`justify-center relative text-xl bg-[#FFFFFF] grid place-items-center text-[#E8DFCA] border-solid rounded-xl ${isMapPressed ? 'pressed' : ''}`}
        style={{ width: "7%" }}
