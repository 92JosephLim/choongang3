...
// export const SERVER_KEY = "1LrPqHLb6nw/ONP2vB0/ZAuTsMXl+jPEatlIJtHTsBzK8ICVqIFfYqIC2tCs6eU47ciVFmqZt3rziKThIZVH3g==";
...
//     // 두 지점 사이의 거리를 계산하여 반환하는 함수
//     // 간단한 구현 예시:
//     const latDiff = Math.abs(p1.getLat() - p2.getLat());
//     const lngDiff = Math.abs(p1.getLng() - p2.getLng());
//     // 위경도 차이를 일반적인 좌표 차이로 변환
...
//                 image={{
//                   src: `${process.env.PUBLIC_URL}/camPing.png`,
//                   size: {
//                     width: 50,
//                     height: 50,
//                   },
...
//                             <img
//                               src={`${process.env.PUBLIC_URL}/locationPing.png`}
//                               alt="Location"
//                               style={{ width: 20, height: 20 }}
//                             />
...
function CampingInfo() {
  ...
  return <KakaoMap campingData={campingData} onZoomChanged={onZoomChanged} onCenterChanged={onCenterChanged}/>;
}
